...
//        StrictMode.setThreadPolicy(policy);
        ...
        //Using recyclerview
        recyclerViewAdapter = new RecyclerViewAdapter(MainActivity.this, notificationArrayList);
...
//            notification.setTitleName(titleData);
//            notification.setTextData(textData);
//            notification.setNotifyDate(date);
//
